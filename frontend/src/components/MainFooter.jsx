  ...
  <div className="container">
    <div className="row">
      ...
      <div className="col-md-4 mb-4">
        <h5 className="fw-bold">FreshSpin Laundry</h5>
        <p className="text-muted">Reliable laundry services to keep your clothes fresh and clean. Fast pickup & delivery in your neighborhood.</p>
      </div>
      <div className="col-md-4 mb-4">
      ...
      <div className="col-md-4 mb-4">
        ...
        <p className="mb-1">✉️ hello@freshspinlaundry.com</p>
        <div className="mt-2">
